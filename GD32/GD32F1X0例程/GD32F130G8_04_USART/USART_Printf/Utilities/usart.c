...
void USART0_Init(void)
{
	...
	/* 配置USART0的TX引脚作为复用功能、复用模式，带上拉电阻 、推挽输出，速度10MHz*/
	...
	/* 配置USART0的RX引脚作为复用功能、复用模式，带上拉电阻 、推挽输出，速度10MHz*/
	...
	/* 配置USART0：波特率115200、使能发送、使能接收（默认：数据位8位、停止位1位，无奇偶校验） */
...
void USART1_Init(void)
{
	...
	/* 配置USART1：波特率115200、使能发送、使能接收（默认：数据位8位、停止位1位，无奇偶校验） */
